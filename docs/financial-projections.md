...
1. Popcorn machine → 2. Kit #2 → 3. Booth + Backdrop → 4. First helper →
5. Kit #3 + crews → 6. Snow cone/soft play/360 booth → 7. Ads + software →
8. Crew chief + premium bundles

## Cash discipline
- Keep business + personal money separate from day 1.
- Reinvest early profit into gear/crews, not personal draw, until Phase 3.
- Only buy the next product when payback is ≤ 4 rentals and demand already exists.
